...
# create a new class based model for the "Programmer" table
...
dan_taylor = Programmer(
    first_name="Dan",
    last_name="Taylor",
    gender="M",
    nationality="British",
    famous_for="Been da best init" 
)
...
# session.add(dan_taylor)


# updating a single record
# programmer = session.query(Programmer).filter_by(id=13).first()
# programmer.famous_for = "Been a real G init"
